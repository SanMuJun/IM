...
import com.exampled.san.im.controller.adapter.PickCotactAdapter;
import com.exampled.san.im.model.Model;
import com.exampled.san.im.model.bean.PickContactInfo;
...
public class PickContactActivity extends Activity {
    ...
    private PickCotactAdapter pickContactAdapter;
    ...
    private void initData() {
        ...
        // 初始化listview
        pickContactAdapter = new PickCotactAdapter(this, mPicks,mExistMembers);
