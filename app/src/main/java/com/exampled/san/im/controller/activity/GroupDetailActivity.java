...
import com.exampled.san.im.controller.adapter.GroupDetailAdapter;
            ...
            public void run() {
                ...
                //从环信服务器获取所有群成员
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(GroupDetailActivity.this, "获取成员成功", Toast.LENGTH_SHORT).show();
                            //刷新适配器
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(GroupDetailActivity.this, "获取成员失败"+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
