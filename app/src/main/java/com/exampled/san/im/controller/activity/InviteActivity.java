...
import com.exampled.san.im.controller.adapter.InviteAdapter;
            ...
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // 数据库更新
                        Model.getInstance().getDbManager().getInviteTableDao().updateInvitationStatus(InvationInfo.InvitationStatus.INVITE_ACCEPT
